...
export default function SiteRow({ site, onSiteClick, onMapClick }) {
  ...
  return (
    <tr className="hover:bg-[hsl(var(--color-surface-elevated))] transition-colors">
      ...
      <td className="px-2 sm:px-3 py-2 sm:py-3 text-center text-[hsl(var(--color-foreground))]">
        {site.expiryIn30Days}
      </td>
      ...
      <td className="px-2 sm:px-3 py-2 sm:py-3 text-right sticky right-0 bg-[hsl(var(--color-card))] hover:bg-[hsl(var(--color-surface-elevated))] z-[5] relative">
        <button className="px-2 sm:px-3 py-1.5 bg-[hsl(var(--color-card))] border border-[hsl(var(--color-border))] rounded text-xs sm:text-sm text-[hsl(var(--color-foreground))] hover:bg-[hsl(var(--color-surface-elevated))] transition-colors flex items-center gap-1">
          Actions
